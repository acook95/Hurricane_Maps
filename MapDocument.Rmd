...
<p>In order to map these hurricanes, the data first had to be cleaned, and several datasets had to be merged together. The process is described briefly below.</p>
<br>
